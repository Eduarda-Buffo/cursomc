...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StanderdError> objectNotFound(ObjectNotFoundException e, HttpServletRequest request){
		...
		StanderdError err = new StanderdError(System.currentTimeMillis(), HttpStatus.NOT_FOUND.value(), "Não encontrado", e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<StanderdError> authorization(AuthorizationException e, HttpServletRequest request) {
		...
		StanderdError err = new StanderdError(System.currentTimeMillis(), HttpStatus.FORBIDDEN.value(), "Acesso negado", e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<StanderdError> file(FileException e, HttpServletRequest request) {
		...
		StanderdError err = new StanderdError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro de arquivo", e.getMessage(), request.getRequestURI());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}
	...
	public ResponseEntity<StanderdError> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		StanderdError err = new StanderdError(System.currentTimeMillis(), code.value(), "Erro Amazon Service", e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<StanderdError> amazonClient(AmazonClientException e, HttpServletRequest request) {
		...
		StanderdError err = new StanderdError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro Amazon Client", e.getMessage(), request.getRequestURI());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}
	...
	public ResponseEntity<StanderdError> amazonS3(AmazonS3Exception e, HttpServletRequest request) {
		...
		StanderdError err = new StanderdError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro S3", e.getMessage(), request.getRequestURI());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}
}
